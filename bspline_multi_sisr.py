...
if __name__ == '__main__':
    ...
    nonlin = curr_config['nonlin']         # type of nonlinearity, 'wire', 'siren', 'mfn', 'relu', 'posenc', 'gauss'
    niters = curr_config['niters']               # Number of SGD iterations (2000)
    learning_rate = curr_config['learning_rate']       # Learning rate. 

    os.makedirs('/rds/general/user/atk23/home/wire/baseline_results/multi_SR', exist_ok=True)
    ...
    metrics[nonlin] = {'psnr_rec': snrval,
            'ssim_rec': ssimval,
            'psnr_interp': snr_interp,
            'ssim_interp': ssim_interp}
    ...
    filepath = f"/rds/general/user/atk23/home/wire/multiscale_results/multi_sisr/{folder_name}"

...
if __name__ == "__main__":
    utils.log("Starting image denoising experiment with posenc activation functions")
    plt.gray()
    ...
    niters = 4000  # Number of SGD iterations (2000)
    expected = [30.2, 26.6, 28.1, 0, 29.2, 29.7]  # Expected PSNR values

    # WIRE works best at 5e-3 to 2e-2, Gauss and SIREN at 1e-3 - 2e-3,
    # MFN at 1e-2 - 5e-2, and positional encoding at 5e-4 to 1e-3

    tau = 0.2e1  # Photon noise (max. mean lambda). Set to 3e7 for representation, 3e1 for denoising

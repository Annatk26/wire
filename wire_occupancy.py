...
if __name__ == "__main__":
    ...
    # Save data
    os.makedirs("/rds/general/user/atk23/home/wire/results/occupancy", exist_ok=True)
    ...
    for nonlin in nonlin_types:
        ...
        io.savemat(
            f"/rds/general/user/atk23/home/wire/results/occupancy/{nonlin}.mat",
            mdict[nonlin],
        )
        ...
        if occupancy:
            savename = (
                f"/rds/general/user/atk23/home/wire/results/occupancy/{nonlin}.dae"
            )

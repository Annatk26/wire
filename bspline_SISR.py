...
if __name__ == '__main__':
    ...
    folder_name = utils.make_unique(
        "form_mscale",
        "/rds/general/user/atk23/home/wire/bspline_results/sisr")
    os.makedirs(
        f"/rds/general/user/atk23/home/wire/bspline_results/sisr/{folder_name}",
        exist_ok=True)
    ...
    for multiscale in multiscale_all:
        if nonlin == 'posenc':
            nonlin = 'relu'
            posencode = True
        ...
        mdict[label] = {
            'Wieght initialization': weight_init,
        ...
        # plt.show()
        plt.imsave(
            f'/rds/general/user/atk23/home/wire/bspline_results/sisr/{folder_name}/MSE_{label}.png',
            np.clip(abs(im - best_img), 0, 1),
            vmin=0.0,
            vmax=0.1)

    io.savemat(
        f"/rds/general/user/atk23/home/wire/bspline_results/sisr/{folder_name}/info.mat",
        mdict)
    io.savemat(
        f"/rds/general/user/atk23/home/wire/bspline_results/sisr/{folder_name}/metrics.mat",
        metrics)

...
img = plt.imshow(
    magnitude_spectrum_log, cmap="YlOrRd", vmin=vmin, vmax=vmax
...
plt.text(
    0.5,
    -0.1,
    f"Min Frequency Magnitude: {min_frequency:.2e}\nMax Frequency Magnitude: {max_frequency:.2f}",
    fontsize=12,
    ha="center",
...
plt.savefig(
    "/rds/general/user/atk23/home/wire/data_freq_content/parrot_original.png",
    bbox_inches="tight",
)
